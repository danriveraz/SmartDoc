    	 	...
    	 	<div class="col-lg-12">
    	 		{!! Form::open(['route' => ['historia.posteditHistoriaClinica'], 'method' => 'POST','enctype' => 'multipart/form-data', 'id' => 'formGuardar']) !!}
       			{{ csrf_field() }}
			        ...
			        <div class="container" id="divOdontogramaAImprimir">
			        ...
			        <div>
		          	...
		          	<div class="">
          				<div class="form-group" style="text-align: center; margin-top: 10px;">
		                    ...
		                    @endif
		                    <a class="factBot btn btn-primary" id="imprimir" href="#" style="color: #FFFFFF;" onclick="imprimr();"><i class="fa fa-print"></i>Imprimir</a>  
		                </div>
	          		</div>
		        {{ Form::close() }}
          	</div>
...
<script>
	...
	function imprimr() {
		...
		document.getElementById('laboratorio').style.display = 'initial';
